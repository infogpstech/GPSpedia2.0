// ============================================================================
// GPSPEDIA-USERS SERVICE (REFACTORED WITH FIXED COLUMN MAP)
// ============================================================================
...
// Mapa de columnas fijo y consistente con auth.js para la hoja "Users".
const COLS_USERS = {
    id: 1,
    nombreUsuario: 2,
    password: 3,
...
function doGet(e) {
  try {
    const response = {
      status: 'success',
      message: 'GPSpedia USERS-SERVICE v1.1 is active.' // Version updated
    };
